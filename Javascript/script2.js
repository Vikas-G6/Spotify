...
async function displayAlbums() {
    ...
    console.log("Number of albums found:", array.length);

    for (let index = 0; index < array.length; index++) {
    const e = array[index];
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            let folder = e.href.split("/").slice(-2)[0]
            let a = await fetch(`http://127.0.0.1:5500/songs/info.json`);
            console.log(a)
            ...
            <img src="/songs/http://127.0.0.1:5500/Songs/cover.jpg" alt="cover">
